...
def add_cwd_segment():
    ...
    if names[0] == '~':
        if Color.HOME_SPECIAL_DISPLAY:
            powerline.append('', Color.HOME_FG, Color.HOME_BG)
        else:
            powerline.append('', Color.PATH_FG, Color.PATH_BG)
    else:
            powerline.append(' ', Color.PATH_FG, Color.PATH_BG,
    ...
    s = ('%s'%names[-1]) + powerline.separator_thin + ' '
    if names[-1] == '~' and Color.HOME_SPECIAL_DISPLAY:
        powerline.append(s, Color.HOME_FG, Color.HOME_BG)
    else:
        powerline.append(s, Color.CWD_FG, Color.PATH_BG)
